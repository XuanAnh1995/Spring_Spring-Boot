...
import com.luuviet.ngoctrinhcoffee.service.CategoryService;
...
public class ProductController {
    ...
    public String create(Model model) {
        ...
        // gửi thêm danh sách category
        model.addAttribute("categories", categoryService.getCategories());

        // gửi object rỗng và category cho màn hình tạo mới
    ...
    public String save(@ModelAttribute("minzy") Product product,
                         Model model,
        ...
        redirectAttributes.addFlashAttribute("formMessage", "Đã update thành công - Mock message");
        redirectAttributes.addFlashAttribute("id", product.getId());
        redirectAttributes.addFlashAttribute("name", product.getName());
        redirectAttributes.addFlashAttribute("price", product.getPrice());

        return "redirect:/products";  // gọi URL: /products để show toàn bộ sản phẩm
    }
